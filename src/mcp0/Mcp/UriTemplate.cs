...
internal sealed class UriTemplate
{
    ...
    {
        StringBuilder result = new(str.Length * 2);
        ...
        Operator? op = null;
        var composite = false;
        var toMaxTokenLengthBuffer = false;
        StringBuilder maxTokenLengthBuffer = new(3);
        var firstToken = true;
            ...
            switch (character)
            {
                ...
                default:
                    if (toToken)
                    {
                        ...
                        else if (toMaxTokenLengthBuffer)
                        {
